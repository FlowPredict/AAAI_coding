...
date = '202106'
df_real = pd.read_csv("./FlightsReal_{}.csv".format(date))
...
df_locations.to_csv('locations_real_06_small.csv')
#
df_loc = pd.read_csv('locations_real_06_small.csv')
num_grids = 10
...
print(np.sum(flow_cube), flow_cube.shape)
np.save('flow_real_2106_small.npy', flow_cube)
